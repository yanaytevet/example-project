...
rsync -av ~/dev/example-project/example-project-web/src/app/shared/ ~/dev/$1/$frontend_directory/src/app/shared/ \
  --exclude='*/routing.service.ts' --exclude='*/breadcrumbs.service.ts' --exclude='string-display/'